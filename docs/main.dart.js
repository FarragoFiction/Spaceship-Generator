...
r=" It is a drone."}if(this.k(8)<=0){r+=" It is a stationary sattelite."
s.push(" Station")
...
v=x.a.length
if(v<=10)u=" It is a small spacecraft."
else u=v<=40?" It is a mid-sized spacecraft.":" It is a large spacecraft."
u=C.a.M(u,x.d)
w.toString
